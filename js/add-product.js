...
createNewProductForm.addEventListener('submit', function (event) {
  ...
  let isProductDescriptionLength = false;
  ...
  if (productDescription.value.length < 280) {
    isProductDescriptionLength = true;
  } else {
    isProductDescriptionLength = false;
    generalMessage.innerHTML += `<div class="rounded-md bg-red-50 p-4">
                                  <div class="flex">
                                    <div class="flex-shrink-0">
                                      <svg class="h-5 w-5 text-red-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                    ...
                                    <div class="ml-3">
                                      <h3 class="text-sm font-medium text-red-800">Description cannot be greater than 280 characters</h3>
                                    </div>
                                  </div>
                                </div>`;
  }
